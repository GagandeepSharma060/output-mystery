  ...
  const features = [
    {
      ...
      description: "Watch bite-sized coding tutorials that get straight to the point. Perfect for busy developers."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Keep track of your learning journey and see how much you've improved over time."
    }
  ];
